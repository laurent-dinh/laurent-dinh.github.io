...
*Laurent&nbsp;Dinh*, [*Jascha&nbsp;Sohl-Dickstein*](http://www.sohldickstein.com/), [*Razvan&nbsp;Pascanu*](https://sites.google.com/view/razp), [*Hugo&nbsp;Larochelle*](http://www.dmi.usherb.ca/~larocheh/index_en.html)  
Piecewise invertible flows for deep mixture models. ([arXiv](https://arxiv.org/abs/1903.07714))
...
We train predictive models on proprioceptive information and show they represent properties of external objects. ([arXiv](https://arxiv.org/abs/1804.06318)) ([videos](https://goo.gl/mZuqAV))
...
[*Junyoung&nbsp;Chung*](https://sites.google.com/site/junyoungchung08/), [*Kyle&nbsp;Kastner*](https://kastnerkyle.github.io/), *Laurent&nbsp;Dinh*, [*Kratarth&nbsp;Goel*](https://www.linkedin.com/in/kratarth-goel-98b37741), [*Aaron&nbsp;Courville*](https://aaroncourville.wordpress.com/), [*Yoshua&nbsp;Bengio*](http://www.iro.umontreal.ca/~bengioy/)  
[**Neural Information Processing Systems 2015**](https://nips.cc/Conferences/2015)

Variational auto-encoder meets Deep-RNN. ([arXiv](http://arxiv.org/abs/1506.02216)) ([code](https://github.com/jych/nips2015_vrnn))

### NICE: Non-linear Independent Components Estimation
*Laurent&nbsp;Dinh*, [*David&nbsp;Krueger*](http://www-etud.iro.umontreal.ca/~kruegerd/), [*Yoshua&nbsp;Bengio*](http://www.iro.umontreal.ca/~bengioy/)  
